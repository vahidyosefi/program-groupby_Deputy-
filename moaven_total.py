...
# input0['Row'] = np.where(input0.Name.str.contains('', regex=False), input0.Name, input0.modify) 
# input0['Row'] = np.where(input0.Name.str.contains('', regex=False), input0.Name, input0.modify)
# input0['Row'] = np.where(input0.Name.str.contains('', regex=False), input0.Name, input0.modify)
...
input0 =  input0[['channel','Row','Operator','Visit','Duration_min','m_date_new','type','حوزه']]
...
# input0.to_excel(r'D:\back up\EPG\14001018\test\Last_version_2\VOD.xlsx', index=False)
input0.to_excel(r'D:\back up\EPG\14010124\VOD\merge_VOD_total.xlsx', index=False)
...
# sarasari_00= pd.read_csv(r'D:\back up\EPG\14001018\sarasari_1.csv')
...
sarasari_05["Duration"] = sarasari_05["Duration"].str.replace('/', '.').astype(float)

#### group by visit and duration

sarasari_gp = sarasari_05.groupby(['channel','Operator','Row','m_date']).agg({'Visit':'sum','Duration':'sum'}).reset_index()
...
df_sarasari_without_Bronmarzi_6["type"] = 'سراسری'
df_sarasari_without_Bronmarzi_6["حوزه"] = df_sarasari_without_Bronmarzi_6["tag"]


print('اتمام برنامه سزاسزی')

len(df_sarasari_without_Bronmarzi_6)

df_sarasari_without_Bronmarzi_6 =  df_sarasari_without_Bronmarzi_6[['channel','Row','Operator','Visit','Duration_min','m_date_new','type','حوزه']]

# df_sarasari_without_Bronmarzi_6.to_excel(r'D:\back up\EPG\14001018\test\Last_version_2\sarasari_gp.xlsx', index=False)

df_sarasari_without_Bronmarzi_6.to_excel(r'D:\back up\EPG\14010124\EPG\sarasari_gp_total.xlsx', index=False)
...
# EPG_BronMarzi.to_excel(r'D:\back up\EPG\14001018\test\EPG_BronMarzi.xlsx', index=False)
EPG_BronMarzi.to_excel(r'D:\back up\EPG\14010124\EPG\EPG_BronMarzi_total_4ch.xlsx', index=False)

df_sarasari_Bronmarzi_1  = sarasari_gp.query("channel== 'العالم'")
df_sarasari_Bronmarzi_2  = sarasari_gp.query("channel== 'الکوثر'")
df_sarasari_Bronmarzi_3  = sarasari_gp.query("channel== 'آی فیلم'")
df_sarasari_Bronmarzi_4  = sarasari_gp.query("channel== 'جام جم 1'")
df_sarasari_Bronmarzi_5  = sarasari_gp.query("channel== 'پرس تی وی'")
# df_sarasari_Bronmarzi_6  = sarasari_gp.query("channel== 'العالم'")


df_sarasari_Bronmarzi = df_sarasari_Bronmarzi_1.append(df_sarasari_Bronmarzi_2)
df_sarasari_Bronmarzi = df_sarasari_Bronmarzi.append(df_sarasari_Bronmarzi_3)
df_sarasari_Bronmarzi = df_sarasari_Bronmarzi.append(df_sarasari_Bronmarzi_4)
df_sarasari_Bronmarzi = df_sarasari_Bronmarzi.append(df_sarasari_Bronmarzi_5)

df_sarasari_Bronmarzi["type"] = 'برون مرزی'
df_sarasari_Bronmarzi["حوزه"] = ''

df_sarasari_Bronmarzi = df_sarasari_Bronmarzi.append(EPG_BronMarzi)

df_sarasari_Bronmarzi =  df_sarasari_Bronmarzi[['channel','Row','Operator','Visit','Duration_min','m_date_new','type','حوزه']]

print('اتمام برنامه برون مرزی')

# df_sarasari_Bronmarzi.to_excel(r'D:\back up\EPG\14001018\test\Last_version_2\Bronmarzi_gp.xlsx', index=False)


df_sarasari_Bronmarzi.to_excel(r'D:\back up\EPG\14010124\EPG\EPG_BronMarzi_total_total.xlsx', index=False)
...
# EPG_radio_00= pd.read_csv(r'D:\back up\EPG\14001018\EPG_radio_.csv')
connection = psycopg2.connect(user="postgres",
                            password="12344321",
                            host="10.32.141.17",
                            port="5432",
...
# EPG_radio_gp.to_excel(r'D:\back up\EPG\14001018\test\Last_version_2\EPG_radio_gp.xlsx', index=False)

EPG_radio_gp.to_excel(r'D:\back up\EPG\14010124\EPG\EPG_radio_gp_total.xlsx', index=False)
...
# EPG_ostani_gp.to_excel(r'D:\back up\EPG\14001018\test\Last_version_2\EPG_ostani_gp.xlsx', index=False)
EPG_ostani_gp.to_excel(r'D:\back up\EPG\14010124\EPG\EPG_ostani_gp_total.xlsx', index=False)
...
# EPG_ekhtesasi_gp.to_excel(r'D:\back up\EPG\14001018\test\Last_version_2\EPG_ekhtesasi_gp.xlsx', index=False)
EPG_ekhtesasi_gp.to_excel(r'D:\back up\EPG\14010124\EPG\EPG_ekhtesasi_gp_total.xlsx', index=False)
...
EPG = df_sarasari_without_Bronmarzi_6.append(df_sarasari_Bronmarzi)
...
EPG.to_excel(r'D:\back up\EPG\14010124\EPG\EPG_gp_total.xlsx', index=False)



EPG_VOD = EPG.append(input0)
len(EPG_VOD)

# EPG_VOD.to_excel(r'D:\back up\EPG\14001018\test\Last_version_2\EPG_VOD_gp.xlsx', index=False)
EPG_VOD.to_excel(r'D:\back up\EPG\14010124\EPG_VOD_gp_total.xlsx', index=False)
